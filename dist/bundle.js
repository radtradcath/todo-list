...
function saveTaskValues(e) {
    ...
    if (editingTask === true) {
        let editedTask = taskToBeEdited.editTask(taskTitle.value, taskDescription.value, taskPriority.value, (0,date_fns_format__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(taskDate.value), 'PPPP'));
        ...
        createTask(taskTitle.value, taskDescription.value, taskPriority.value, (0,date_fns_format__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(taskDate.value), 'PPPP'));
    }
